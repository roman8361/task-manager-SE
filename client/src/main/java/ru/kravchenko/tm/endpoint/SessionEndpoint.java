...
public interface SessionEndpoint {
    ...
    public ru.kravchenko.tm.endpoint.Session openSession(
    ...
    @WebMethod
    @Action(input = "http://endpoint.tm.kravchenko.ru/SessionEndpoint/closeSessionRequest", output = "http://endpoint.tm.kravchenko.ru/SessionEndpoint/closeSessionResponse", fault = {@FaultAction(className = SessionNotFoundException_Exception.class, value = "http://endpoint.tm.kravchenko.ru/SessionEndpoint/closeSession/Fault/SessionNotFoundException")})
