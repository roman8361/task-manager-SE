 ...
 * 2019-06-06T10:09:51.441+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "SessionEndpointService",
                  wsdlLocation = "http://127.0.0.1:80/SessionEndpoint?WSDL",
                  targetNamespace = "http://endpoint.tm.kravchenko.ru/")
public class SessionEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://endpoint.tm.kravchenko.ru/", "SessionEndpointService");
    public final static QName SessionEndpointPort = new QName("http://endpoint.tm.kravchenko.ru/", "SessionEndpointPort");
    static {
        URL url = null;
        try {
            url = new URL("http://127.0.0.1:80/SessionEndpoint?WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SessionEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://127.0.0.1:80/SessionEndpoint?WSDL");
        }
        WSDL_LOCATION = url;
    }
