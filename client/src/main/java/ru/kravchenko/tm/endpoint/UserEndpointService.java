 ...
 * 2019-06-10T12:22:23.088+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "UserEndpointService",
                  wsdlLocation = "http://127.0.0.1:80/UserEndpoint?WSDL",
                  targetNamespace = "http://endpoint.tm.kravchenko.ru/")
public class UserEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://endpoint.tm.kravchenko.ru/", "UserEndpointService");
    public final static QName UserEndpointPort = new QName("http://endpoint.tm.kravchenko.ru/", "UserEndpointPort");
    static {
        URL url = null;
        try {
            url = new URL("http://127.0.0.1:80/UserEndpoint?WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://127.0.0.1:80/UserEndpoint?WSDL");
        }
        WSDL_LOCATION = url;
    }
