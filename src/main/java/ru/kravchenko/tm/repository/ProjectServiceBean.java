...
public class ProjectServiceBean implements ProjectService {
    ...
    private static ProjectServiceBean instance;

    public ProjectServiceBean() {}

    public static synchronized ProjectServiceBean getInstance() {
        if (instance == null) {
            instance = new ProjectServiceBean();
        }
        return instance;
    }
    ...
    @Override
    public @NotNull void createProject() {
